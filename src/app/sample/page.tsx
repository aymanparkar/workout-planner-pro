...
export default function WorkoutLogAppComponent() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container py-4 px-4 sm:px-6 lg:px-8">
              ...
              <div key={index} className="space-y-2 p-4 bg-muted rounded-lg">
                <div className="flex flex-col space-y-1.5">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      updateExercise(index, "muscle", value)
                    }
                  >
                ...
                {exercise.muscle === "custom" && (
                  <div className="flex flex-col space-y-1.5">
                    <Label htmlFor={`custom-muscle-${index}`}>
                      Custom Muscle Group
                    </Label>
                    <Input
                      ...
                      onChange={(e) =>
                        updateExercise(index, "customMuscle", e.target.value)
                      }
                    />
                  </div>
                )}
